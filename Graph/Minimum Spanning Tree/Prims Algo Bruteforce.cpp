...
int main()
{
    ...
    for(int count = 0;count<V-1;count++){
        ...
        //in key array index is node and value is weight  of this corresponding node to reach,here we will find minimum weighted node 
        //basically here we will find minimum weighted edge
        for(int v = 0;v<V;v++){
